...
Процедура ПриОткрытии(Отказ)
	...
	НоваяВерсияКонфигурацииNC = "3.4.28.1";
	Если ЭтаФорма.ВерсияКонфигурацииNC <> НоваяВерсияКонфигурацииNC Тогда
		...
		ТекстВопроса = "Конфигурация обновлена до версии " + НоваяВерсияКонфигурацииNC + ". " + "Показать список изменений?";
		Ответ = Вопрос(ТекстВопроса,РежимДиалогаВопрос.ДаНет,,КодВозвратаДиалога.Да,"Обновление конфигурации");
