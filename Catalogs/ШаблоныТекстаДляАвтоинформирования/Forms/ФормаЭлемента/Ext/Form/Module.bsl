...
Процедура ПриОткрытииНаСервере()
	ЭтаФорма.РазрешитьРедактированиеШаблоновСМС = Константы.РазрешитьРедактированиеШаблоновСМС.Получить();
КонецПроцедуры
...
Процедура ПриОткрытии(Отказ)
	...
	КонецЕсли;
	Если ЭтаФорма.РазрешитьРедактированиеШаблоновСМС = Ложь Тогда
...
Процедура УстановитьВидимостьЭлементов()
	Если Объект.НазначениеШаблона = 
			ПредопределенноеЗначение("Перечисление.ВариантыДействийДляСкоринга.EMailРассылка") Тогда
		Элементы.ШаблонHTML.Доступность = Истина;
		Элементы.ПрикрепляемыеФайлы.Доступность = Истина;
		Элементы.ТипыПрикрепляемыхФайлов.Доступность = Истина;
		Элементы.ФормаОтправитьEMail.Доступность = Истина;
		Элементы.ГруппаСтраницыЦентр.ТекущаяСтраница = Элементы.ГруппаТаблицыШаблона;
		Элементы.ГруппаПримерТекста.Видимость = Ложь;
		Элементы.ПримерHTML.Видимость = Истина;	
		Элементы.ФормаОчиститьШаблон.Доступность = Истина;
		Элементы.ГруппаУведомления.Видимость = Истина;
	Иначе
		Элементы.ШаблонHTML.Доступность = Ложь;
		Элементы.ПрикрепляемыеФайлы.Доступность = Ложь;
		Элементы.ТипыПрикрепляемыхФайлов.Доступность = Ложь;
		Элементы.ФормаОтправитьEMail.Доступность = Ложь;
		Элементы.ГруппаСтраницыЦентр.ТекущаяСтраница = Элементы.ГруппаТекстШаблона;
		Элементы.ГруппаПримерТекста.Видимость = Истина;
		Элементы.ПримерHTML.Видимость = Ложь;
		Элементы.ФормаОчиститьШаблон.Доступность = Ложь;
...
Процедура ПередатьВФормуОтправки(Команда)
	...
	ИначеЕсли
		ФормаСМС.Открыта() = Ложь ИЛИ ФормаВЦ.Открыта() = Ложь Тогда
		Предупреждение("Не удалось передать сообщение",,"Шаблоны СМС");
	КонецЕсли;
КонецПроцедуры
