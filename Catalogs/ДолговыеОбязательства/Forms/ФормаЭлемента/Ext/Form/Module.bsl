...
Процедура ОбновитьИП(Команда)
	...
	ПоказатьОповещениеПользователя("Обмен с ФССП",,"Информация обновлена",БиблиотекаКартинок.NC_ПодсистемаФССП);
...
Процедура ОбновитьДелаОБанкротстве(Команда)
	...
	ПоказатьОповещениеПользователя("Обмен с ЕФРСБ",,"Информация обновлена",БиблиотекаКартинок.NC_ПодсистемаБанкротство);
