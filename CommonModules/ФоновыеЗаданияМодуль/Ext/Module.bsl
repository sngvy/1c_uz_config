...
Процедура ФормированиеСписковАвтообзвона() Экспорт
	...
	|				И ДолговыеОбязательства.Код ПОДОБНО ""%"" + &ГСЧ1 + ""%""
	...
	|				И ДолговыеОбязательства.Код ПОДОБНО ""%"" + &ГСЧ2 + ""%""
	|				И ДолговыеОбязательства.ЗапретАвтообзвона = ЛОЖЬ
	|				И ДолговыеОбязательства.НеконтактныеНомера = ЛОЖЬ
	|				И Мероприятие.Ссылка ЕСТЬ НЕ NULL
	|				И Мероприятие.Результат.РезультативныйКонтакт = ИСТИНА 
	...
	|				И ДолговыеОбязательства.Код ПОДОБНО ""%"" + &ГСЧ3 + ""%""
	|				И ДолговыеОбязательства.ЗапретАвтообзвона = ЛОЖЬ
	|				И ДолговыеОбязательства.НеконтактныеНомера = ЛОЖЬ
	|				И Мероприятие.Ссылка ЕСТЬ НЕ NULL
	|				И Мероприятие.Результат.РезультативныйКонтакт = ИСТИНА 
	...
	|				И ДолговыеОбязательства.Код ПОДОБНО ""%"" + &ГСЧ4 + ""%""
	|				И ДолговыеОбязательства.ЗапретАвтообзвона = ЛОЖЬ
	|				И ДолговыеОбязательства.НеконтактныеНомера = ЛОЖЬ
	|				И Мероприятие.Ссылка ЕСТЬ НЕ NULL
	|				И Мероприятие.Результат.РезультативныйКонтакт = ИСТИНА 
	...
	|				И ДолговыеОбязательства.Код ПОДОБНО ""%"" + &ГСЧ5 + ""%""
	|				И ДолговыеОбязательства.ЗапретАвтообзвона = ЛОЖЬ
	|				И ДолговыеОбязательства.НеконтактныеНомера = ЛОЖЬ
	|				И Мероприятие.Ссылка ЕСТЬ НЕ NULL
	|				И Мероприятие.Результат.РезультативныйКонтакт = ИСТИНА 
	...
	|				И ДолговыеОбязательства.Код ПОДОБНО ""%"" + &ГСЧ6 + ""%""
	|				И ДолговыеОбязательства.ЗапретАвтообзвона = ЛОЖЬ
	|				И ДолговыеОбязательства.НеконтактныеНомера = ЛОЖЬ
	|				И Мероприятие.Ссылка ЕСТЬ НЕ NULL
	|				И Мероприятие.Результат.РезультативныйКонтакт = ИСТИНА 
	...
	|
	|ИМЕЮЩИЕ
	|	МАКСИМУМ(Мероприятие.Дата) < &Позавчера
	|
	|УПОРЯДОЧИТЬ ПО
...
Процедура ФормированиеСписковАвтообзвонаПараметры(Знач Запрос)
	...
	Запрос.УстановитьПараметр("Позавчера", Дата);
...
Процедура БлокировкаДелДляАвтообзвона() Экспорт
	...
	|	МАКСИМУМ(Мероприятие.Дата) < &Позавчера И
