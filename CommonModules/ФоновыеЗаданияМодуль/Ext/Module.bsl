...
Процедура ФормированиеСписковАвтообзвона() Экспорт
	...
	|				И ДолговыеОбязательства.НеконтактныеНомера = ЛОЖЬ
	|				И Мероприятие.Ссылка ЕСТЬ НЕ NULL
	|				И Мероприятие.Результат.Наименование <> ""Email""
	|				И Мероприятие.Результат.Наименование <> ""IVR""
	|				И Мероприятие.Результат.Наименование <> ""Viber""
	|				И Мероприятие.Результат.Наименование <> ""WhatsApp""
	|				И Мероприятие.Результат.Наименование <> ""Запрос кредитору""
	|				И Мероприятие.Результат.Наименование <> ""Заявка на закрепление""
	|				И Мероприятие.Результат.Наименование <> ""Заявка на открепление""
	|				И Мероприятие.Результат.Наименование <> ""Контроль оплаты""
	|				И Мероприятие.Результат.Наименование <> ""Отправка СМС""
	|				И Мероприятие.Результат.Наименование <> ""Розыск должника""
	|				И Мероприятие.Результат.Наименование <> ""Служебное""
	|			ИЛИ ДолговыеОбязательства.ДополнительныеРеквизиты.Значение.Наименование = ""В работе""
	|				И ДолговыеОбязательства.Должник.ЧасовойПояс = ""Antarctica/Casey""
	|				И ДолговыеОбязательства.Наименование ПОДОБНО ""%"" + &ГСЧ2 + ""%""
	|				И ДолговыеОбязательства.ЗапретАвтообзвона = ЛОЖЬ
