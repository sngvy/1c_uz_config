...
Процедура ПриОткрытии(Отказ)
	...
	ПолучитьЗаголовокНачальнойСтраницы();
...
Процедура ПроверитьОбновленияКонфигурации()
	...
	НоваяВерсияКонфигурацииNC = "5.8.26.2";
...
Процедура ПолучитьЗаголовокНачальнойСтраницы()
	ЭтаФорма.Заголовок = "Текущие дела — " + ПользователиКлиентСервер.ТекущийПользователь() + " — " + Формат(ТекущаяДата(), "ДФ='dd.MM.yyyy HH:mm'");
КонецПроцедуры
