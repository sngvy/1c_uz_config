...
Процедура ОбработкаПроведения(Отказ, Режим)
	...
	Если Не Отказ Тогда
		Запрос.Текст = "ВЫБРАТЬ
		               |	СкорингДолговыхОбязательствОбъекты.Объект КАК Объект,
		               |	СкорингДолговыхОбязательствОбъекты.Категория КАК Категория,
		               |	СкорингДолговыхОбязательствОбъекты.Ссылка.Скоринг КАК Скоринг,
		               |	СкорингДолговыхОбязательствОбъекты.НомерСтроки КАК НомерСтроки,
		               |	СкорингДолговыхОбязательствОбъекты.КатегорияСтарая КАК КатегорияСтарая
		               ...
		               |	ТаблицаДокумента.Категория КАК Категория,
		               |	ТаблицаДокумента.Скоринг КАК Скоринг,
		               ...
		               |	ТаблицаДокумента.КатегорияСтарая КАК КатегорияСтарая
		               ...
		               |	ВременнаяТаблица.Категория КАК Категория,
		               |	ВременнаяТаблица.Скоринг КАК Скоринг,
		               |	ВременнаяТаблица.ОбъектNULL КАК ОбъектNULL,
		               |	ВременнаяТаблица.НомерСтроки КАК НомерСтроки,
		               |	ВременнаяТаблица.КатегорияСтарая КАК КатегорияСтарая
		               |ИЗ
...
Процедура РаспределитьСервер() Экспорт
	...
	Если ПараметрДанныхКонецПериода <> Неопределено Тогда
		ПараметрДанныхКонецПериода.Значение = ТекущаяДатаСеанса();
