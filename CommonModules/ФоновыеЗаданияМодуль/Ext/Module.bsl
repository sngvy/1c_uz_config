...
Процедура ФормированиеСписковАвтообзвона() Экспорт
	...
	|	ДолговыеОбязательства.Наименование КАК Наименование
	|ИЗ
	...
	|		И ДолговыеОбязательства.Наименование ПОДОБНО &ГСЧ7
	|		И Мероприятие.Ссылка ЕСТЬ НЕ NULL
...
Процедура ФормированиеСписковАвтообзвонаГСЧ(Знач Запрос)
	...
	СлучайноеЧисло = Строка("%"+ГСЧ.СлучайноеЧисло(0, 10)+"%");
