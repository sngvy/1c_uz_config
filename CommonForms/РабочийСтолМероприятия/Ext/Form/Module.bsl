...
Процедура ПроверитьОбновленияКонфигурации()
	...
	НоваяВерсияКонфигурацииNC = "3.10.22.3";
...
Процедура ПереустановитьВЦ(Команда)
	ПоказатьОповещениеПользователя("Интеграция с WhatsApp",,"Выполняется переустановка...",БиблиотекаКартинок.NC_ПодсистемаИнтеграцияСWhatsApp);
