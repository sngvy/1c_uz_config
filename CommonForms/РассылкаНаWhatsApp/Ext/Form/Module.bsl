...
Процедура Отправить(Команда)
	...
	Предупреждение("Выполняется отправка сообщения...",1);
...
Процедура ШаблоныСМС(Команда)
	...
	ФормаСпискаШаблонов = ПолучитьФорму("Справочник.ШаблоныТекстаДляАвтоинформирования.Форма.ФормаСписка",,,Новый УникальныйИдентификатор());
