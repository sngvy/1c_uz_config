...
//}}MRG[ <-> ]
		...
		// Установить корпоративный стиль платформы	
		Если ПараметрыСеанса.АвторизованныйПользователь <> Справочники.Пользователи.НайтиПоНаименованию("Администратор") Тогда
			ГлавныйСтиль = БиблиотекаСтилей["NC"];
		КонецЕсли;
		//
