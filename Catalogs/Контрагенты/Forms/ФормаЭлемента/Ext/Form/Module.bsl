...
Процедура ИсходящийЗвонокТЧ(Команда)
	...
	Если ЭтаФорма.ТекущийЭлемент = ЭтаФорма.Элементы.Телефоны И Элементы.Телефоны.ТекущиеДанные <> Неопределено Тогда
		...
		НовоеМероприятие.Объект.Контакт = ЭтаФорма.Элементы.Телефоны.ТекущиеДанные.Номер;
		...
		НовоеМероприятие.СозданоИзКонтрагента = Истина;
		НовоеМероприятие.НеОбрабатыватьСтатусБитФона = Истина;
...
Процедура ОтправитьСМС(Команда)
	Если ЭтаФорма.РольЮД = Истина Тогда
		Если ЭтаФорма.ТекущийЭлемент = ЭтаФорма.Элементы.Телефоны И Элементы.Телефоны.ТекущиеДанные <> Неопределено Тогда
			...
			НоваяЗадача.Объект.Контакт = ЭтаФорма.Элементы.Телефоны.ТекущиеДанные.Номер;
			НоваяЗадача.КонтрагентКЛ = ЭтаФорма.Объект.Ссылка;
			// Указать источник создания
			НоваяЗадача.СозданоИзКонтрагента = Истина;
