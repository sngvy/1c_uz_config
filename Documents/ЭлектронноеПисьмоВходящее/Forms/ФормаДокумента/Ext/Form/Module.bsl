...
ДокОснование = Новый Структура("ДокументОснованиеВходящее", Объект.Ссылка);
ФормаДокумента = ОткрытьФорму("Документ.ПрикрепитьФайлы.Форма.ФормаДокумента", ДокОснование);
ФормаДокумента.Объект.Дата = ТекущаяДата();
ФормаДокумента.Этаформа.Элементы.ФайлыСкопировать.Видимость = Ложь;
