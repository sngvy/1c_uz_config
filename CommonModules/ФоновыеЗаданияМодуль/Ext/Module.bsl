...
Процедура ФормированиеСписковАвтообзвона() Экспорт
	...
	|				И ДолговыеОбязательства.Наименование ПОДОБНО &Н1
	...
	|				И ДолговыеОбязательства.Наименование ПОДОБНО &Н2
	|				И ДолговыеОбязательства.АвтообзвонЗапрещен = ЛОЖЬ
	|				И Мероприятие.Ссылка ЕСТЬ НЕ NULL 
	|			ИЛИ ДолговыеОбязательства.ДополнительныеРеквизиты.Значение.Наименование = ""В работе""
	|				И ДолговыеОбязательства.Должник.ЧасовойПояс = ""AET""
	|				И ДолговыеОбязательства.Наименование ПОДОБНО &Н3
	|				И ДолговыеОбязательства.АвтообзвонЗапрещен = ЛОЖЬ
	|				И Мероприятие.Ссылка ЕСТЬ НЕ NULL 
	|			ИЛИ ДолговыеОбязательства.ДополнительныеРеквизиты.Значение.Наименование = ""В работе""
	|				И ДолговыеОбязательства.Должник.ЧасовойПояс = ""Asia/Chita""
	|				И ДолговыеОбязательства.Наименование ПОДОБНО &Н4
	|				И ДолговыеОбязательства.АвтообзвонЗапрещен = ЛОЖЬ
	|				И Мероприятие.Ссылка ЕСТЬ НЕ NULL 
	|			ИЛИ ДолговыеОбязательства.ДополнительныеРеквизиты.Значение.Наименование = ""В работе""
	|				И ДолговыеОбязательства.Должник.ЧасовойПояс = ""Asia/Brunei""
	|				И ДолговыеОбязательства.Наименование ПОДОБНО &Н5
	|				И ДолговыеОбязательства.АвтообзвонЗапрещен = ЛОЖЬ
	|				И Мероприятие.Ссылка ЕСТЬ НЕ NULL 
	|			ИЛИ ДолговыеОбязательства.ДополнительныеРеквизиты.Значение.Наименование = ""В работе""
	|				И ДолговыеОбязательства.Должник.ЧасовойПояс = ""ACT""
	|				И ДолговыеОбязательства.Наименование ПОДОБНО &Н6
	|				И ДолговыеОбязательства.АвтообзвонЗапрещен = ЛОЖЬ
	|				И Мероприятие.Ссылка ЕСТЬ НЕ NULL 
	|			ИЛИ ДолговыеОбязательства.ДополнительныеРеквизиты.Значение.Наименование = ""В работе""
	|				И ДолговыеОбязательства.Должник.ЧасовойПояс = ""Antarctica/Davis""
	|				И ДолговыеОбязательства.Наименование ПОДОБНО &Н7
	|				И ДолговыеОбязательства.АвтообзвонЗапрещен = ЛОЖЬ
	|				И Мероприятие.Ссылка ЕСТЬ НЕ NULL 
...
Процедура ФормированиеСписковАвтообзвонаПараметры(Знач Запрос)
	...
	Запрос.УстановитьПараметр("Н1", СлучайноеЧисло);
	
	ГСЧ = Новый ГенераторСлучайныхЧисел();
	СлучайноеЧисло = Строка("%"+ГСЧ.СлучайноеЧисло(1, 10)+"%");
	Запрос.УстановитьПараметр("Н2", СлучайноеЧисло);
	ГСЧ = Новый ГенераторСлучайныхЧисел();
	
	СлучайноеЧисло = Строка("%"+ГСЧ.СлучайноеЧисло(1, 10)+"%");
	Запрос.УстановитьПараметр("Н3", СлучайноеЧисло);
	
	ГСЧ = Новый ГенераторСлучайныхЧисел();
	СлучайноеЧисло = Строка("%"+ГСЧ.СлучайноеЧисло(1, 10)+"%");
	Запрос.УстановитьПараметр("Н4", СлучайноеЧисло);
	
	ГСЧ = Новый ГенераторСлучайныхЧисел();
	СлучайноеЧисло = Строка("%"+ГСЧ.СлучайноеЧисло(1, 10)+"%");
	Запрос.УстановитьПараметр("Н5", СлучайноеЧисло);
	
	ГСЧ = Новый ГенераторСлучайныхЧисел();
	СлучайноеЧисло = Строка("%"+ГСЧ.СлучайноеЧисло(1, 10)+"%");
	Запрос.УстановитьПараметр("Н6", СлучайноеЧисло);
	
	ГСЧ = Новый ГенераторСлучайныхЧисел();
	СлучайноеЧисло = Строка("%"+ГСЧ.СлучайноеЧисло(1, 10)+"%");
	Запрос.УстановитьПараметр("Н7", СлучайноеЧисло);
...
Процедура ОбновлениеОстатков() Экспорт
	...
	//// Выгрузить остатки из регистра накопления для ЮД
	//
	//"ВЫБРАТЬ
...
Процедура БлокировкаДелДляАвтообзвона() Экспорт
	...
	|				И ДолговыеОбязательства.АвтообзвонЗапрещен = ЛОЖЬ
	|				И Мероприятие.Ссылка ЕСТЬ НЕ NULL 
	|				И (Мероприятие.Дата МЕЖДУ &Д И &Д2)
...
Процедура БлокировкаДелДляАвтообзвонаПараметры(Знач Запрос)
	...
	Запрос.УстановитьПараметр("Д2", Дата);
...
Процедура РазблокировкаДелДляАвтообзвона() Экспорт
	...
	Запрос = Новый Запрос;
	// Установить параметры в отдельной процедуре
	РазблокировкаДелДляАвтообзвонаПараметры(Запрос);
    //
	Запрос.Текст =
	"ВЫБРАТЬ РАЗЛИЧНЫЕ
	|	ДолговыеОбязательства.Ссылка КАК Ссылка,
...
Процедура РазблокировкаДелДляАвтообзвонаПараметры(Знач Запрос)
