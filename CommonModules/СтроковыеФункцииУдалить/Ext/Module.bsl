...
Функция СтрокаЛатиницей(Знач Значение) Экспорт
	...
	Возврат ОбщегоНазначенияСлужебныйКлиентСерверУдалить.СтрокаЛатиницей(Значение, ПравилаТранслитерации);
...
Функция ПредставлениеПериодаВТексте(ДатаНачала, ДатаОкончания, ФорматнаяСтрока = "", СЗаглавнойБуквы = Ложь) Экспорт 
	...
	Возврат ОбщегоНазначенияСлужебныйКлиентСерверУдалить.ПредставлениеПериодаВТексте(
