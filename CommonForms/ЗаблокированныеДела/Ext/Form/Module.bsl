...
Процедура Разблокировать(Команда)
	Если ЭтаФорма.ТекущийЭлемент = ЭтаФорма.Элементы.СписокДО И Элементы.СписокДО.ТекущиеДанные <> Неопределено Тогда
		...
		Состояние("Пожалуйста, подождите...", 50, "Выполняется разблокировка дел", БиблиотекаКартинок.NC_Разблокировано);
		РазблокироватьНаСервере();
		Состояние("Пожалуйста, подождите...", 100, "Выполняется разблокировка дел", БиблиотекаКартинок.NC_Разблокировано);
