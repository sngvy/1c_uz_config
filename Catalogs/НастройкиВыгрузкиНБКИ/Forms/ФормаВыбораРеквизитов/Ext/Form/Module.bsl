...
Процедура тзМетаданныеВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	...
	Если ПризнакЗакрытия = Истина Тогда
		Оповестить("НастройкиНБКИВыборРеквизита", СтруктураРеквизита);
...
Процедура ПриОткрытии(Отказ)
	...
	Если ТипЗНЧ(Этаформа.ВладелецФормы.Объект.Ссылка) = Тип("СправочникСсылка.НастройкиВыгрузкиНБКИ") Тогда
