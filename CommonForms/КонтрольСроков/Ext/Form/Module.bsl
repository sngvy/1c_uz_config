...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	ЭтаФорма.СписокДООбработанные.Параметры.УстановитьЗначениеПараметра("ТекущаяДата", ТекущаяДата());
	ЭтаФорма.СписокДОПросроченные.Параметры.УстановитьЗначениеПараметра("ТекущаяДата", ТекущаяДата());
КонецПроцедуры
...
Процедура ПолучитьКоличествоСтрокВДинамическомСпискеНаСервере() Экспорт
	...
	Если КолСтрокДС > 0 Тогда
		ЭтаФорма.КоличествоПросроченных = КолСтрокДС;
	Иначе
	КонецЕсли;
КонецПроцедуры
