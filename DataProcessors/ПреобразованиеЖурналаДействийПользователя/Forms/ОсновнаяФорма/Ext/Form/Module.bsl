...
Процедура ПриОткрытии(Отказ)
	...
	Объект.ИмяОсновнойПроцедуры = "ТестовыйСценарий_" + ОчиститьДату(Формат(ОбщегоНазначенияКлиент.ДатаСеанса(), "ДЛФ=D"));
...
Процедура ВариантВстроенногоЯзыкаПриИзменении(Элемент)
	...
	Объект.ИмяОсновнойПроцедуры = 
		?(Объект.ВариантВстроенногоЯзыка = "ru", "ТестовыйСценарий_", "TestScenario_")
		+ ОчиститьДату(Формат(ОбщегоНазначенияКлиент.ДатаСеанса(), "ДЛФ=D"));
