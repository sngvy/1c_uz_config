...
Процедура ПриОпределенииОбъектовСКомандамиПечати(СписокОбъектов) Экспорт
	...
	СтруктураОписания = ПодключаемыеКомандыУНФ.ОписаниеОбъектовПодключаемыхКоманд();
	...
	СписокОбъектов.Добавить(ОбщегоНазначения.ОбщийМодуль("Справочники.ДоверенностиНалогоплательщика"));
	СписокОбъектов.Добавить(ОбщегоНазначения.ОбщийМодуль("Справочники.СерииНоменклатуры"));
	СписокОбъектов.Добавить(ОбщегоНазначения.ОбщийМодуль("Справочники.ШтрихкодыУпаковокТоваров"));
	
	СписокОбъектов.Добавить(ОбщегоНазначения.ОбщийМодуль("Документы.ДоговорКредитаИЗайма"));
	СписокОбъектов.Добавить(ОбщегоНазначения.ОбщийМодуль("Документы.КорректировкаПоступления"));
	СписокОбъектов.Добавить(ОбщегоНазначения.ОбщийМодуль("Документы.ПачкаРазделов6РасчетаРСВ_1"));
	СписокОбъектов.Добавить(ОбщегоНазначения.ОбщийМодуль("Документы.РасходыПриИмпорте"));
	
	СписокОбъектов.Добавить(ОбщегоНазначения.ОбщийМодуль("Обработки.БанкИКасса"));
	СписокОбъектов.Добавить(ОбщегоНазначения.ОбщийМодуль("Обработки.ПечатьРазделаБСправкиТТН"));
	...
	// ГОСИС
	ИнтеграцияИСУНФ.ПриОпределенииОбъектовСКомандамиПечати(СписокОбъектов);
	// Конец ГОСИС
