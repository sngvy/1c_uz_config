...
Функция ДанныеПоЧастямПути(Объект, ЧастиПутиКДанным, ИдентификаторСтроки)
	...
	Если ЧастиПутиКДанным.Количество() > 1 Тогда
		Если СтрНачинаетсяС(Строка(Объект[ЧастиПутиКДанным[0]]), "ДокументТабличнаяЧасть")
			ИЛИ СтрНачинаетсяС(Строка(Объект[ЧастиПутиКДанным[0]]), "СправочникТабличнаяЧасть") Тогда
