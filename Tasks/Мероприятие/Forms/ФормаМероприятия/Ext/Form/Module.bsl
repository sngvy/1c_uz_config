...
Процедура ПриОткрытии(Отказ)
	...
	Если ЕстьИП() Или ЕстьДоБ() Тогда
		ЭтаФорма.Элементы.ЕстьВнешняяИнформация.Видимость = Истина;
	КонецЕсли;
	Если ЕстьДоБ() Тогда
		Предупреждение("Есть информация о банкротстве",,"Интеграция с Федресурсом");
	КонецЕсли;
КонецПроцедуры
