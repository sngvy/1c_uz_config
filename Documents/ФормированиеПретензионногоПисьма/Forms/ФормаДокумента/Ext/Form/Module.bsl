...
Процедура ПеренестиВОбъектыОтобранныеДО()
	...
	ОтобранныеДО = Справочники.ДолговыеОбязательства.ПолучитьОтобранныеДолговыеОбязательства(Параметры.КомпоновщикСпискаДО);
...
Функция СформироватьКомплекты()
	...
	Для каждого СтрокаНабора Из НаборОснований Цикл
	
		ДанныеШаблона = КомплектыБинарныйФормат.Получить(СтрокаНабора.Основание);
		ОснованиеСКоличеством = Новый Структура;
		ОснованиеСКоличеством.Вставить("Основание", СтрокаНабора.Основание);
		ОснованиеСКоличеством.Вставить("Количество", СтрокаНабора.Количество);
