...
Процедура ПолучитьСведения(Должник, Код) Экспорт
	...
	// Интеграция с ЕФРСБ больше недоступна	
	...
	//	Заголовки.Вставить("Cookie", "_ym_uid=174601109241701423; _ym_d=1746011092; qrator_jsr=v2.0.1746473647.281.5d5cc256yDo0Tx5L|Xd2BQKiIGKciOCI7|gcwu4oOUqlma40sEEBD2z9VoG7+ExcfvR2TwmEpv6I8lg1LLDAdoFyJ1DeP3aiR05VwB3MsT56QqqdIBrc/aZg==-qZI/j1ZQauyUBL4cmR96Z1GIVJ8=-00; qrator_jsid2=v2.0.1746473647.281.5d5cc256yDo0Tx5L|T9lkaUhdmdC4ygO8|w+x8GJoCsyzPU2jnrfKdIvB5kd3UmKJQmng/NAQIsT/ZGWdMDMyA9L226NBqVbGL1eEb3Q6NRG2FYBcFW1fY3DLiem71ETQDiHtwdmqdO2SA78IEA7Y02MCCLqtBM2qiG2Mewc7i3BAuhx6xVlSaYw==-fxOFdvSP4mUKQXZ2C8hw+bGV2sY=; _ym_isad=2; _ym_visorc=b");
	...
	//				Если ДатаРождения = ОбъектыСервер.ПолучитьЗначениеСвойства(Справочники.Контрагенты.НайтиПоКоду(Код), "0043") Тогда
	//					
	//					Заголовки = Новый Соответствие;
	//					Заголовки.Вставить("User-Agent", "Mozilla/5.0 (Windows NT 6.3; WOW64; Trident/7.0; rv:11.0) like Gecko");
	//					Заголовки.Вставить("Host","fedresurs.ru");
