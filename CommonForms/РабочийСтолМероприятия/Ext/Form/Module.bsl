...
Процедура ПроверитьОбновленияКонфигурации()
	...
	НоваяВерсияКонфигурацииNC = "5.12.23.1";
...
Процедура ЗапуститьБитФон()
	Если ЭтаФорма.ЗапускатьБИТPhone = Истина Тогда
		...
		ФормаБитфона.кнПереподключить(Неопределено);
...
Процедура УправлениеОстатками(Команда)
	...
	Иначе
		Предупреждение("Нарушение прав доступа!",,"Управление остатками");
	КонецЕсли;
КонецПроцедуры
...
Процедура ЗапуститьIVR(Команда)
	...
	Иначе
		Предупреждение("Нарушение прав доступа!",,"Запуск IVR");
	КонецЕсли;	
КонецПроцедуры
...
Процедура ПропущенныеВызовы(Команда)
	...
	Иначе
		Предупреждение("Нарушение прав доступа!",,"Пропущенные вызовы");
	КонецЕсли;
КонецПроцедуры
...
Процедура СменитьРежимМероприятий(Команда)
	Если ЭтаФорма.РольРКЦ Или ЭтаФорма.РольАБД Тогда
		...
		КонецЕсли;
	Иначе
		Предупреждение("Нарушение прав доступа!",,"Режим мероприятий");
	КонецЕсли;
КонецПроцедуры
