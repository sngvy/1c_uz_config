...
Процедура ФормированиеСписковАвтообзвона() Экспорт
	...
	// Отказники, просроченные, неконтактные (дальние регионы)
	
	СписокАвтообзвона = Справочники.СписокДляАвтообзвона.СоздатьЭлемент();
	СписокАвтообзвона.Наименование = "Отказники, просроченные, неконтактные (дальние регионы) " + Формат(ТекущаяДата(), "ДФ=dd.MM.yyyy");
	
	Запрос = Новый Запрос;
	// Используем ГСЧ для случайного порядка договоров
	ФормированиеСписковАвтообзвонаГСЧ(Запрос);
    //
	Запрос.Текст = 
	"ВЫБРАТЬ РАЗЛИЧНЫЕ
	|	ДолговыеОбязательства.Ссылка КАК Ссылка,
	|	ДолговыеОбязательства.Должник.ЧасовойПояс КАК ЧасовойПояс,
	|	ДолговыеОбязательства.Должник.КодКонтрагента КАК КодКонтрагента
	|ИЗ
	|	Задача.Мероприятие КАК Мероприятие
	|		ПРАВОЕ СОЕДИНЕНИЕ Справочник.ДолговыеОбязательства КАК ДолговыеОбязательства
	|			ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.бит_ИсторияЗвонков КАК бит_ИсторияЗвонков
	|			ПО бит_ИсторияЗвонков.Абонент = ДолговыеОбязательства.Должник
	...
	|		И ДолговыеОбязательства.Должник.КодКонтрагента ПОДОБНО &ГСЧ1
	|		И Мероприятие.Ссылка ЕСТЬ НЕ NULL
	|		И бит_ИсторияЗвонков.ДлительностьЗвонка >= &ГСЧ13
	|
	...
	|		И ДолговыеОбязательства.Должник.КодКонтрагента ПОДОБНО &ГСЧ2
	|		И Мероприятие.Ссылка ЕСТЬ НЕ NULL
	|		И бит_ИсторияЗвонков.ДлительностьЗвонка >= &ГСЧ14
	|
	|		ИЛИ ДолговыеОбязательства.ДополнительныеРеквизиты.Значение.Наименование = ""В работе""
	|		И ДолговыеОбязательства.Должник.ЧасовойПояс = ""AET""
	|		И ДолговыеОбязательства.Должник.КодКонтрагента ПОДОБНО &ГСЧ3
	|		И Мероприятие.Ссылка ЕСТЬ НЕ NULL
	|		И бит_ИсторияЗвонков.ДлительностьЗвонка >= &ГСЧ15
	|
	|		ИЛИ ДолговыеОбязательства.ДополнительныеРеквизиты.Значение.Наименование = ""В работе""
	|		И ДолговыеОбязательства.Должник.ЧасовойПояс = ""Asia/Chita""
	|		И ДолговыеОбязательства.Должник.КодКонтрагента ПОДОБНО &ГСЧ4
	|		И Мероприятие.Ссылка ЕСТЬ НЕ NULL
	|		И бит_ИсторияЗвонков.ДлительностьЗвонка >= &ГСЧ16
	|
	|		ИЛИ ДолговыеОбязательства.ДополнительныеРеквизиты.Значение.Наименование = ""В работе""
	|		И ДолговыеОбязательства.Должник.ЧасовойПояс = ""Asia/Brunei""
	|		И ДолговыеОбязательства.Должник.КодКонтрагента ПОДОБНО &ГСЧ5
	|		И Мероприятие.Ссылка ЕСТЬ НЕ NULL
	|		И бит_ИсторияЗвонков.ДлительностьЗвонка >= &ГСЧ17
	|
	|		ИЛИ ДолговыеОбязательства.ДополнительныеРеквизиты.Значение.Наименование = ""В работе""
	|		И ДолговыеОбязательства.Должник.ЧасовойПояс = ""ACT""
	|		И ДолговыеОбязательства.Должник.КодКонтрагента ПОДОБНО &ГСЧ6
	|		И Мероприятие.Ссылка ЕСТЬ НЕ NULL
	|		И бит_ИсторияЗвонков.ДлительностьЗвонка >= &ГСЧ18
	|
	|		ИЛИ ДолговыеОбязательства.ДополнительныеРеквизиты.Значение.Наименование = ""В работе""
	|		И ДолговыеОбязательства.Должник.ЧасовойПояс = ""Antarctica/Davis""
	|		И ДолговыеОбязательства.Должник.КодКонтрагента ПОДОБНО &ГСЧ7
	|		И Мероприятие.Ссылка ЕСТЬ НЕ NULL
	|		И бит_ИсторияЗвонков.ДлительностьЗвонка >= &ГСЧ19)
	|УПОРЯДОЧИТЬ ПО
	|	КодКонтрагента ВОЗР";
	
	ВыгрузкаВСписокАвтообзвона(Запрос, СписокАвтообзвона);
    
	// Отказники, просроченные, неконтактные (основной)
	
	СписокАвтообзвона = Справочники.СписокДляАвтообзвона.СоздатьЭлемент();
	СписокАвтообзвона.Наименование = "Отказники, просроченные, неконтактные (основные регионы) " + Формат(ТекущаяДата(), "ДФ=dd.MM.yyyy");
	...
	|		И ДолговыеОбязательства.Должник.КодКонтрагента ПОДОБНО &ГСЧ8
	|		И Мероприятие.Ссылка ЕСТЬ НЕ NULL
	|		И бит_ИсторияЗвонков.ДлительностьЗвонка >= &ГСЧ20
	|
	|		ИЛИ ДолговыеОбязательства.ДополнительныеРеквизиты.Значение.Наименование = ""В работе""
	|		И ДолговыеОбязательства.Должник.ЧасовойПояс = ""Antarctica/Mawson""
	|		И ДолговыеОбязательства.Должник.КодКонтрагента ПОДОБНО &ГСЧ9
	|		И Мероприятие.Ссылка ЕСТЬ НЕ NULL
	|		И бит_ИсторияЗвонков.ДлительностьЗвонка >= &ГСЧ21
	|
	|		ИЛИ ДолговыеОбязательства.ДополнительныеРеквизиты.Значение.Наименование = ""В работе""
	|		И ДолговыеОбязательства.Должник.ЧасовойПояс = ""Asia/Baku""
	|		И ДолговыеОбязательства.Должник.КодКонтрагента ПОДОБНО &ГСЧ10
	|		И Мероприятие.Ссылка ЕСТЬ НЕ NULL
	|		И бит_ИсторияЗвонков.ДлительностьЗвонка >= &ГСЧ22
	|
	|		ИЛИ ДолговыеОбязательства.ДополнительныеРеквизиты.Значение.Наименование = ""В работе""
	|		И ДолговыеОбязательства.Должник.ЧасовойПояс = ""Antarctica/Syowa""
	|		И ДолговыеОбязательства.Должник.КодКонтрагента ПОДОБНО &ГСЧ11
	|		И Мероприятие.Ссылка ЕСТЬ НЕ NULL
	|		И бит_ИсторияЗвонков.ДлительностьЗвонка >= &ГСЧ23
	|
	|		ИЛИ ДолговыеОбязательства.ДополнительныеРеквизиты.Значение.Наименование = ""В работе""
	|		И ДолговыеОбязательства.Должник.ЧасовойПояс = ""EET""
	|		И ДолговыеОбязательства.Должник.КодКонтрагента ПОДОБНО &ГСЧ12
	|		И Мероприятие.Ссылка ЕСТЬ НЕ NULL
	|		И бит_ИсторияЗвонков.ДлительностьЗвонка >= &ГСЧ24)
	|УПОРЯДОЧИТЬ ПО
	|	КодКонтрагента ВОЗР";
	
	ВыгрузкаВСписокАвтообзвона(Запрос, СписокАвтообзвона);
	
	// Список по дальним регионам
	...
	|ГДЕ
	|	(ДолговыеОбязательства.ДополнительныеРеквизиты.Значение.Наименование = ""В работе""
	|				И ДолговыеОбязательства.ДополнительныеРеквизиты.Значение.Наименование = ""Комиссия""
	|				И ДолговыеОбязательства.Должник.ЧасовойПояс = ""Antarctica/McMurdo""
	|				И ДолговыеОбязательства.Должник.КодКонтрагента ПОДОБНО &ГСЧ1
	...
	// Список по дальним регионам - цессия
	
	СписокАвтообзвона = Справочники.СписокДляАвтообзвона.СоздатьЭлемент();
	СписокАвтообзвона.Наименование = "Дальние регионы (цессия) " + Формат(ТекущаяДата(), "ДФ=dd.MM.yyyy");
	...
	// Список по основным регионам - цессия
	
	СписокАвтообзвона = Справочники.СписокДляАвтообзвона.СоздатьЭлемент();
	СписокАвтообзвона.Наименование = "Основные регионы (цессия) " + Формат(ТекущаяДата(), "ДФ=dd.MM.yyyy");
...
Процедура ФормированиеСписковАвтообзвонаГСЧ(Знач Запрос)
	
	Перем ГСЧ, СлучайноеЧисло;
	
	ГСЧ = Новый ГенераторСлучайныхЧисел();
	СлучайноеЧисло = Строка("%"+ГСЧ.СлучайноеЧисло(1, 12)+"%");
	Запрос.УстановитьПараметр("ГСЧ1", СлучайноеЧисло);
	
	ГСЧ = Новый ГенераторСлучайныхЧисел();
	СлучайноеЧисло = ГСЧ.СлучайноеЧисло(10, 30);
	Запрос.УстановитьПараметр("ГСЧ13", СлучайноеЧисло);
	...
	ГСЧ = Новый ГенераторСлучайныхЧисел();
	СлучайноеЧисло = ГСЧ.СлучайноеЧисло(10, 30);
	Запрос.УстановитьПараметр("ГСЧ14", СлучайноеЧисло);
	...
	ГСЧ = Новый ГенераторСлучайныхЧисел();
	СлучайноеЧисло = ГСЧ.СлучайноеЧисло(10, 30);
	Запрос.УстановитьПараметр("ГСЧ15", СлучайноеЧисло);
	...
	ГСЧ = Новый ГенераторСлучайныхЧисел();
	СлучайноеЧисло = ГСЧ.СлучайноеЧисло(10, 30);
	Запрос.УстановитьПараметр("ГСЧ16", СлучайноеЧисло);
	...
	Запрос.УстановитьПараметр("ГСЧ5", СлучайноеЧисло);
		...
		ГСЧ = Новый ГенераторСлучайныхЧисел();
	СлучайноеЧисло = ГСЧ.СлучайноеЧисло(10, 30);
	Запрос.УстановитьПараметр("ГСЧ17", СлучайноеЧисло);
	...
	ГСЧ = Новый ГенераторСлучайныхЧисел();
	СлучайноеЧисло = ГСЧ.СлучайноеЧисло(10, 30);
	Запрос.УстановитьПараметр("ГСЧ18", СлучайноеЧисло);
	
	ГСЧ = Новый ГенераторСлучайныхЧисел();
	СлучайноеЧисло = Строка("%"+ГСЧ.СлучайноеЧисло(1, 12)+"%");
	Запрос.УстановитьПараметр("ГСЧ7", СлучайноеЧисло);
	
	ГСЧ = Новый ГенераторСлучайныхЧисел();
	СлучайноеЧисло = ГСЧ.СлучайноеЧисло(10, 30);
	Запрос.УстановитьПараметр("ГСЧ19", СлучайноеЧисло);
	
	ГСЧ = Новый ГенераторСлучайныхЧисел();
	СлучайноеЧисло = Строка("%"+ГСЧ.СлучайноеЧисло(1, 12)+"%");
	Запрос.УстановитьПараметр("ГСЧ8", СлучайноеЧисло);
	
	ГСЧ = Новый ГенераторСлучайныхЧисел();
	СлучайноеЧисло = ГСЧ.СлучайноеЧисло(10, 30);
	Запрос.УстановитьПараметр("ГСЧ20", СлучайноеЧисло);
	
	ГСЧ = Новый ГенераторСлучайныхЧисел();
	СлучайноеЧисло = Строка("%"+ГСЧ.СлучайноеЧисло(1, 12)+"%");
	Запрос.УстановитьПараметр("ГСЧ9", СлучайноеЧисло);
	
	ГСЧ = Новый ГенераторСлучайныхЧисел();
	СлучайноеЧисло = ГСЧ.СлучайноеЧисло(10, 30);
	Запрос.УстановитьПараметр("ГСЧ21", СлучайноеЧисло);
	
	ГСЧ = Новый ГенераторСлучайныхЧисел();
	СлучайноеЧисло = Строка("%"+ГСЧ.СлучайноеЧисло(1, 12)+"%");
	Запрос.УстановитьПараметр("ГСЧ10", СлучайноеЧисло);
	
	ГСЧ = Новый ГенераторСлучайныхЧисел();
	СлучайноеЧисло = ГСЧ.СлучайноеЧисло(10, 30);
	Запрос.УстановитьПараметр("ГСЧ22", СлучайноеЧисло);
	
	ГСЧ = Новый ГенераторСлучайныхЧисел();
	СлучайноеЧисло = Строка("%"+ГСЧ.СлучайноеЧисло(1, 12)+"%");
	Запрос.УстановитьПараметр("ГСЧ11", СлучайноеЧисло);
	
	ГСЧ = Новый ГенераторСлучайныхЧисел();
	СлучайноеЧисло = ГСЧ.СлучайноеЧисло(10, 30);
	Запрос.УстановитьПараметр("ГСЧ23", СлучайноеЧисло);
	
	ГСЧ = Новый ГенераторСлучайныхЧисел();
	СлучайноеЧисло = Строка("%"+ГСЧ.СлучайноеЧисло(1, 12)+"%");
	Запрос.УстановитьПараметр("ГСЧ12", СлучайноеЧисло);
	
	ГСЧ = Новый ГенераторСлучайныхЧисел();
	СлучайноеЧисло = ГСЧ.СлучайноеЧисло(10, 30);
	Запрос.УстановитьПараметр("ГСЧ24", СлучайноеЧисло);
...
Процедура ОбновлениеДнейПросрочки() Экспорт  
	...
	|ГДЕ
	|  ДолговыеОбязательства.ДополнительныеРеквизиты.Значение.Наименование = ""В работе""
	|  ИЛИ ДолговыеОбязательства.ДополнительныеРеквизиты.Значение.Наименование = ""Ручной обзвон""";
	...
	Пока Выборка.Следующий() Цикл    
		ДО = Выборка.Ссылка;
		ДатаВозвр = ОбъектыСервер.ПолучитьЗначениеСвойства(ДО, "0162");
		Если ЗначениеЗаполнено(ДатаВозвр) Тогда
			ДнейПросрочки = (НачалоДня(ТекущаяДата())-НачалоДня(ДатаВозвр))/86400;
			...
			ДнейНаДатуПер = (ДнейПросрочки-ДнейВАгентстве);
			ОбъектыСервер.ЗаписатьЗначениеСвойства(ДО, "0139", ДнейНаДатуПер);
		КонецЕсли;
	КонецЦикла;
КонецПроцедуры
...
Процедура ОбновлениеОстатков() Экспорт
	...
	|ГДЕ
	|	ДолговыеОбязательства.Кредитор.Код = ""000037809""
	...
	|";
	// |	ИЛИ ДолговыеОбязательства.Кредитор = "F00001401"
	...
	Пока Выборка.Следующий() Цикл
		...
		// Провести синхронизацию с внесудебкой
