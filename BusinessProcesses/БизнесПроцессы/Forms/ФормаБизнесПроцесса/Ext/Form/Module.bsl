...
Процедура ОбработатьОбъектУчета()
	...
	Настройки = НастройкаУчета();
	Настройка = Настройки.Получить(ТипЗнч(Объект.Объект));
	...
	Настройка["Группа"].Видимость = Истина;
	Элементы.ГруппаОбъектУчета.ТекущаяСтраница = Настройка["Группа"];
	ТекущийЭлемент = Настройка["Элемент"];
...
Процедура УстановитьПометкуУдаления(Ссылка)
	...
	Пока Результат.Следующий() Цикл
		...
		Мероприятие.УстановитьПометкуУдаления(Истина);
	КонецЦикла;
КонецПроцедуры
