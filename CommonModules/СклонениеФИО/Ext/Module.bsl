...
Функция daСклонение(_Выражение, _Падеж = "И", _Род = "", _Режим = "ФИО", _ФорматнаяСтрока = "") Экспорт
	...
	|М;		ХОЙ/ШОЙ/;											2;			ого;	ому;	ого;	им;		ом;     Плохой, Большой
	...
	Если _Параметр0 = "_РазделитьСтроку" Тогда
		...
		_ПозРазделителя = Найти(_Параметр1, _Параметр2); _Режим = Сред(_Параметр1, _ПозРазделителя + 1); Возврат Лев(_Параметр1, _ПозРазделителя - 1);
