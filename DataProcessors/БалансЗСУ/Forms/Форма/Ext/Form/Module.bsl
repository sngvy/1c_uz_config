...
Процедура ПриЗаписиНаСервере(Отказ, ТекущийОбъект, ПараметрыЗаписи)
	...
	Ключи = ОбработкаБезопасноеХранилище.КлючиЗСУ();
	...
	Для каждого Ключ Из Ключи Цикл
		...
		Если ЭтаФорма[Ключ + "Изменен"] Тогда
			...
			ОбработкаБезопасноеХранилище.Записать("ЗСУ", Ключ, ЭтаФорма[Ключ]);
...
&НаКлиенте
Процедура КонстантыНаборСервисСУАдресПриИзменении(Элемент)
	АдресИзменен = Истина;
КонецПроцедуры

&НаКлиенте
Процедура КонстантыНаборСервисСУЛогинПриИзменении(Элемент)
	ЛогинИзменен = Истина;
КонецПроцедуры

&НаКлиенте
Процедура КонстантыНаборСервисСУПарольПриИзменении(Элемент)
	ПарольИзменен = Истина;
КонецПроцедуры

&НаСервере
Процедура ОбработатьПароль()

	Ключи = ОбработкаБезопасноеХранилище.КлючиЗСУ();
	Учетка = ОбработкаБезопасноеХранилище.ПолучитьВсеЗначения("ЗСУ");
	
	Для каждого Ключ Из Ключи Цикл
	
		ЭтаФорма[Ключ] = Учетка[Ключ];
