...
Процедура ПриОткрытии(Отказ)
	...
	Если День(ТекущаяДата()) = 12 Тогда
		ПоказатьОповещениеПользователя("Ротация портфеля",,"Осталось 3 дня до ротации",БиблиотекаКартинок.Предупреждение32,СтатусОповещенияПользователя.Важное);
	ИначеЕсли День(ТекущаяДата()) = 13 Тогда
		ПоказатьОповещениеПользователя("Ротация портфеля",,"Осталось 2 дня до ротации",БиблиотекаКартинок.Предупреждение32,СтатусОповещенияПользователя.Важное); 
	ИначеЕсли День(ТекущаяДата()) = 14 Тогда
		ПоказатьОповещениеПользователя("Ротация портфеля",,"Остался 1 день до ротации",БиблиотекаКартинок.Предупреждение32,СтатусОповещенияПользователя.Важное); 
	ИначеЕсли День(ТекущаяДата()) = 15 Тогда
		ПоказатьОповещениеПользователя("Ротация портфеля",,"Сегодня день ротации портфеля",БиблиотекаКартинок.Предупреждение32,СтатусОповещенияПользователя.Важное);
	...
	ПоказатьОповещениеПользователя("Обработка обещаний",,"Обработайте обещания до 11:00",БиблиотекаКартинок.Предупреждение32,СтатусОповещенияПользователя.Важное);
	КонецЕсли;
