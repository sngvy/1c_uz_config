...
Процедура ОбработчикСобытияВходящийЗвонок(Данные)
	...
	КонецЕсли;
	ПоказатьОповещениеПользователя(ТекстЗаголовка, , Текст,БиблиотекаКартинок.NC_Подсистема_бтБИТАТС);
...
Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник)
	...
	Если ИмяСобытия = "ОбработатьСостояниеЗвонка" Тогда
		Если ЭтаФорма.СостояниеЗвонка = "ЗвонокОтклонён" Тогда
			ПоказатьОповещениеПользователя("БИТ.Phone",,"Нет ответа",БиблиотекаКартинок.NC_Подсистема_бтБИТАТС);
		...
		ИначеЕсли ЭтаФорма.СостояниеЗвонка = "ЗвонокПрерван" Тогда
			Если ЭтаФорма.ДлительностьРазговора = "0:00:00" Тогда
				ПоказатьОповещениеПользователя("БИТ.Phone",,"Вызов сброшен",БиблиотекаКартинок.NC_Подсистема_бтБИТАТС);
				Оповестить("ОбновитьВремяРаботы");
			...
			ИначеЕсли ЭтаФорма.ДлительностьРазговора <> "0:00:00"
				...
				ИЛИ ЭтаФорма.ДлительностьРазговора <> "0:00:04"
				ИЛИ ЭтаФорма.ДлительностьРазговора <> "0:00:05" Тогда
				ПоказатьОповещениеПользователя("БИТ.Phone",,"Разговор завершен. Длительность разговора: "+ЭтаФорма.ДлительностьРазговора,БиблиотекаКартинок.NC_Подсистема_бтБИТАТС);
				Оповестить("ОбновитьВремяРаботы");
