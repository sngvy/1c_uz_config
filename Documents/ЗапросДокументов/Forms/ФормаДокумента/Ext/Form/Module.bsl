...
Процедура ПриОткрытииНаСервере()
	...
	Для каждого ЗаписьНабора из НаборЗаписей Цикл
		ЭтаФорма.ДолгПоТелу = ЗаписьНабора.СуммаРегл;
	КонецЦикла;
	НаборЗаписей = РегистрыСведений.ЗадолженностьПоОбъектамОстатки.СоздатьНаборЗаписей();
	НаборЗаписей.Отбор.Объект.Установить(ЭтаФорма.Объект.Договор);
	...
	НаборЗаписей.Прочитать(); 
	Для каждого ЗаписьНабора из НаборЗаписей Цикл
		ЭтаФорма.ДолгПоПроцентам = ЗаписьНабора.СуммаРегл;
	КонецЦикла;
	НаборЗаписей = РегистрыСведений.ЗадолженностьПоОбъектамОстатки.СоздатьНаборЗаписей();
	НаборЗаписей.Отбор.Объект.Установить(ЭтаФорма.Объект.Договор);
	...
	НаборЗаписей.Прочитать(); 
	Для каждого ЗаписьНабора из НаборЗаписей Цикл
		ЭтаФорма.ПениШтрафы = ЗаписьНабора.СуммаРегл;
	КонецЦикла;
КонецПроцедуры
...
Процедура ПриОткрытии(Отказ)
	...
	Если ЭтаФорма.Авторизованный = ЭтаФорма.РКЦ
		...
		ЭтаФорма.КоманднаяПанель.ПодчиненныеЭлементы.СоздатьДокумент.Видимость = Истина;
	Иначе
		ЭтаФорма.КоманднаяПанель.ПодчиненныеЭлементы.СоздатьДокумент.Видимость = Ложь;
	КонецЕсли;
