...
&НаКлиенте
Функция УбратьЗапрещенныеСимволыВИмениФайла(Текст) Экспорт

	ЗапрещенныеСимволы = ЗапрещенныеСимволыВИмениФайла();
...
&НаКлиенте
Функция ЗапрещенныеСимволыВИмениФайла() Экспорт
