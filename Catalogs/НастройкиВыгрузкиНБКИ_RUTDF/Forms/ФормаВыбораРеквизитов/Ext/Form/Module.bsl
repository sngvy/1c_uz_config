...
Процедура тзМетаданныеВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	...
	Если ПризнакЗакрытия = Истина Тогда
		Оповестить("НастройкиНБКИВыборРеквизитаRUTDF", СтруктураРеквизита);
...
Процедура ПриОткрытии(Отказ)
	...
	Если ТипЗНЧ(Этаформа.ВладелецФормы.Объект.Ссылка) = Тип("СправочникСсылка.НастройкиВыгрузкиНБКИ_RUTDF") Тогда
		ВыбранноеЗначение = ЗначениеСФормыРодителя;  	
	КонецЕсли;
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка) 
	Если Параметры.Свойство("ВыбранноеЗначение") тогда
        ЗначениеСФормыРодителя=Параметры.ВыбранноеЗначение;
    КонецЕсли;
КонецПроцедуры
