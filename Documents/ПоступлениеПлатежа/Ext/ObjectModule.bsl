...
Процедура ОбработкаПроведения(Отказ, Режим)
	...
	Для Каждого ТекСтрокаРазнесениеПоСудебнымРешениям Из РазнесениеПоСудебнымРешениям Цикл
		...
		// Провести списание с внесудебки
		...
		// Разнести платеж по составляющим внесудебки
		...
		Пока Выборка.Следующий() Цикл
			// Разнести по пеням
			Если ЗначениеЗаполнено(Выборка.ПениДООстаток) Тогда
				Если Выборка.ПениДООстаток - ТекСтрокаРазнесениеПоСудебнымРешениям.Сумма > 0 Тогда
					ТекСтрокаРазнесениеПоСудебнымРешениям.ТипЗадолженности = ПланыВидовХарактеристик.ТипыЗадолженностиПоРешению.Пени; 
					Для Каждого ТекСтрокаРазнесениеПоСудебнымРешениям Из РазнесениеПоСудебнымРешениям Цикл
						Движение[ТекСтрокаРазнесениеПоСудебнымРешениям.ТипЗадолженности.ИмяПредопределенныхДанных + "ДО"] = Движение[ТекСтрокаРазнесениеПоСудебнымРешениям.ТипЗадолженности.ИмяПредопределенныхДанных + "ДО"] + ТекСтрокаРазнесениеПоСудебнымРешениям.Сумма;	
						Движение[ТекСтрокаРазнесениеПоСудебнымРешениям.ТипЗадолженности.ИмяПредопределенныхДанных + "Регл"] = Движение[ТекСтрокаРазнесениеПоСудебнымРешениям.ТипЗадолженности.ИмяПредопределенныхДанных + "Регл"] + ТекСтрокаРазнесениеПоСудебнымРешениям.Сумма;
					КонецЦикла;
				ИначеЕсли Выборка.ПениДООстаток - ТекСтрокаРазнесениеПоСудебнымРешениям.Сумма < 0 Тогда
					СуммаНеразнесенная = ТекСтрокаРазнесениеПоСудебнымРешениям.Сумма - Выборка.ПениДООстаток;
					СуммаКРазнесению = ТекСтрокаРазнесениеПоСудебнымРешениям.Сумма - СуммаНеразнесенная; 
					ТекСтрокаРазнесениеПоСудебнымРешениям.ТипЗадолженности = ПланыВидовХарактеристик.ТипыЗадолженностиПоРешению.Пени;
					ТекСтрокаРазнесениеПоСудебнымРешениям.Сумма = СуммаКРазнесению;	
					Для Каждого ТекСтрокаРазнесениеПоСудебнымРешениям Из РазнесениеПоСудебнымРешениям Цикл
						Движение[ТекСтрокаРазнесениеПоСудебнымРешениям.ТипЗадолженности.ИмяПредопределенныхДанных + "ДО"] = Движение[ТекСтрокаРазнесениеПоСудебнымРешениям.ТипЗадолженности.ИмяПредопределенныхДанных + "ДО"] + ТекСтрокаРазнесениеПоСудебнымРешениям.Сумма;	
						Движение[ТекСтрокаРазнесениеПоСудебнымРешениям.ТипЗадолженности.ИмяПредопределенныхДанных + "Регл"] = Движение[ТекСтрокаРазнесениеПоСудебнымРешениям.ТипЗадолженности.ИмяПредопределенныхДанных + "Регл"] + ТекСтрокаРазнесениеПоСудебнымРешениям.Сумма;
					КонецЦикла;
				КонецЕсли;
			ИначеЕсли ЗначениеЗаполнено(Выборка.ПроцентыДООстаток) Тогда
				// Разнести по процентам
				Если Выборка.ПроцентыДООстаток - ТекСтрокаРазнесениеПоСудебнымРешениям.Сумма > 0 Тогда
					ТекСтрокаРазнесениеПоСудебнымРешениям.ТипЗадолженности = ПланыВидовХарактеристик.ТипыЗадолженностиПоРешению.Проценты;
					Для Каждого ТекСтрокаРазнесениеПоСудебнымРешениям Из РазнесениеПоСудебнымРешениям Цикл
						Движение[ТекСтрокаРазнесениеПоСудебнымРешениям.ТипЗадолженности.ИмяПредопределенныхДанных + "ДО"] = Движение[ТекСтрокаРазнесениеПоСудебнымРешениям.ТипЗадолженности.ИмяПредопределенныхДанных + "ДО"] + ТекСтрокаРазнесениеПоСудебнымРешениям.Сумма;	
						Движение[ТекСтрокаРазнесениеПоСудебнымРешениям.ТипЗадолженности.ИмяПредопределенныхДанных + "Регл"] = Движение[ТекСтрокаРазнесениеПоСудебнымРешениям.ТипЗадолженности.ИмяПредопределенныхДанных + "Регл"] + ТекСтрокаРазнесениеПоСудебнымРешениям.Сумма;
					КонецЦикла;
				ИначеЕсли Выборка.ПроцентыДООстаток - ТекСтрокаРазнесениеПоСудебнымРешениям.Сумма < 0 Тогда
					Если ЗначениеЗаполнено(СуммаНеразнесенная) Тогда
						СуммаНеразнесенная = СуммаНеразнесенная + (ТекСтрокаРазнесениеПоСудебнымРешениям.Сумма - Выборка.ПроцентыДООстаток);
					Иначе
						СуммаНеразнесенная = ТекСтрокаРазнесениеПоСудебнымРешениям.Сумма - Выборка.ПроцентыДООстаток;
					КонецЕсли;
					СуммаКРазнесению = ТекСтрокаРазнесениеПоСудебнымРешениям.Сумма - СуммаНеразнесенная;
					ТекСтрокаРазнесениеПоСудебнымРешениям.ТипЗадолженности = ПланыВидовХарактеристик.ТипыЗадолженностиПоРешению.Проценты;
					ТекСтрокаРазнесениеПоСудебнымРешениям.Сумма = СуммаКРазнесению;	
					...
					КонецЦикла;
				КонецЕсли;
			ИначеЕсли ЗначениеЗаполнено(Выборка.ОсновнойДолгДООстаток) Тогда
				// Разнести по ОД
				Если Выборка.ОсновнойДолгДООстаток - ТекСтрокаРазнесениеПоСудебнымРешениям.Сумма > 0 Тогда
					ТекСтрокаРазнесениеПоСудебнымРешениям.ТипЗадолженности = ПланыВидовХарактеристик.ТипыЗадолженностиПоРешению.ОсновнойДолг;
					Для Каждого ТекСтрокаРазнесениеПоСудебнымРешениям Из РазнесениеПоСудебнымРешениям Цикл
						Движение[ТекСтрокаРазнесениеПоСудебнымРешениям.ТипЗадолженности.ИмяПредопределенныхДанных + "ДО"] = Движение[ТекСтрокаРазнесениеПоСудебнымРешениям.ТипЗадолженности.ИмяПредопределенныхДанных + "ДО"] + ТекСтрокаРазнесениеПоСудебнымРешениям.Сумма;	
						Движение[ТекСтрокаРазнесениеПоСудебнымРешениям.ТипЗадолженности.ИмяПредопределенныхДанных + "Регл"] = Движение[ТекСтрокаРазнесениеПоСудебнымРешениям.ТипЗадолженности.ИмяПредопределенныхДанных + "Регл"] + ТекСтрокаРазнесениеПоСудебнымРешениям.Сумма;
					КонецЦикла;
				ИначеЕсли Выборка.ОсновнойДолгДООстаток - ТекСтрокаРазнесениеПоСудебнымРешениям.Сумма < 0 Тогда
					Если ЗначениеЗаполнено(СуммаНеразнесенная) Тогда
						СуммаНеразнесенная = СуммаНеразнесенная + (ТекСтрокаРазнесениеПоСудебнымРешениям.Сумма - Выборка.ПроцентыДООстаток);
					Иначе
						СуммаНеразнесенная = ТекСтрокаРазнесениеПоСудебнымРешениям.Сумма - Выборка.ПроцентыДООстаток;
			...
			Если ЗначениеЗаполнено(СуммаНеразнесенная) Тогда 
				// Разнести переплату
				ТекСтрокаРазнесениеПоСудебнымРешениям.ТипЗадолженности = ПланыВидовХарактеристик.ТипыЗадолженностиПоРешению.ОсновнойДолг;
				ТекСтрокаРазнесениеПоСудебнымРешениям.Сумма = СуммаНеразнесенная;
				Для Каждого ТекСтрокаРазнесениеПоСудебнымРешениям Из РазнесениеПоСудебнымРешениям Цикл
					Движение[ТекСтрокаРазнесениеПоСудебнымРешениям.ТипЗадолженности.ИмяПредопределенныхДанных + "ДО"] = Движение[ТекСтрокаРазнесениеПоСудебнымРешениям.ТипЗадолженности.ИмяПредопределенныхДанных + "ДО"] + ТекСтрокаРазнесениеПоСудебнымРешениям.Сумма;	
					Движение[ТекСтрокаРазнесениеПоСудебнымРешениям.ТипЗадолженности.ИмяПредопределенныхДанных + "Регл"] = Движение[ТекСтрокаРазнесениеПоСудебнымРешениям.ТипЗадолженности.ИмяПредопределенныхДанных + "Регл"] + ТекСтрокаРазнесениеПоСудебнымРешениям.Сумма;
				КонецЦикла;
				ОстатокДО = СуммаКРазнесению + СуммаНеразнесенная;
			КонецЕсли;
	КонецЦикла;
КонецЦикла;
	
	ПосчитатьОбщуюСуммуПоВнесудебке(Движение, РазнесениеПоСудебнымРешениям);
	
	// Обновить остаток
	Если ЗначениеЗаполнено(ОстатокДО) Тогда
		Движение.СуммаДО = ОстатокДО;
		Движение.СуммаРегл = ОстатокДО;
	КонецЕсли;
