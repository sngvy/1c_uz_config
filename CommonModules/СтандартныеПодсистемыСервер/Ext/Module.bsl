...
Процедура ПриОпределенииНазначенияРолей(НазначениеРолей) Экспорт
	...
	НазначениеРолей.ТолькоДляАдминистраторовСистемы.Добавить(
		Метаданные.Роли.тсАдминистрирование.Имя);
...
Процедура ПередЗапускомПрограммы()
	...
	МинимальнаяВерсияПлатформы = "8.3.20.1710";
	...
	ПоддерживаемаяВерсияПлатформы = "8.3.20";
	...
	ИначеЕсли ТекущийРежим = Режимы.Версия8_3_18 Тогда
		НеПоддерживаемаяВерсияПлатформы = "8.3.18";
	ИначеЕсли ТекущийРежим = Режимы.Версия8_3_19 Тогда
		НеПоддерживаемаяВерсияПлатформы = "8.3.19";
	Иначе
		НеПоддерживаемаяВерсияПлатформы = ?(СтрЗаканчиваетсяНа(Строка(ТекущийРежим), "8_3_20"), "", Строка(ТекущийРежим));
	КонецЕсли;
	...
	Если Не ЗначениеЗаполнено(ПользователиИнформационнойБазы.ТекущийПользователь().Имя)
	   ...
	   И ОбновлениеИнформационнойБазыСлужебный.ВерсияИБ("СтандартныеПодсистемы",
		...
		// Заглушка для Такси, чтобы регламентные задания не падали
