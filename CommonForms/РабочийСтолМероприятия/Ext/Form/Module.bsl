...
Процедура ПриОткрытииНаСервере()
	...
	ЭтаФорма.Версия = Константы.ВерсияКонфигурацииNC.Получить();
...
Процедура ПриОткрытии(Отказ)
	...
	Если ЭтаФорма.Версия <> "3.3.18" Тогда
		ФормаСпискаИзменений = ПолучитьФорму("ОбщаяФорма.ОбновлениеКонфигурации");
		ФормаСпискаИзменений.Открыть();
	ИначеЕсли ЭтаФорма.Версия = "3.3.18" И ЭтаФорма.ПоказыватьСписокИзменений = Истина Тогда
		ФормаСпискаИзменений = ПолучитьФорму("ОбщаяФорма.ОбновлениеКонфигурации");
		ФормаСпискаИзменений.Открыть();
	КонецЕсли;
...
Процедура ОбновитьПортфель(Команда)
	Предупреждение("Выполняется обновление портфеля...",1);
	Элементы.СписокДО.Обновить();
