...
Процедура ПроверитьОбновленияКонфигурации()
	...
	НоваяВерсияКонфигурацииNC = "3.5.23.3";
...
Процедура ПроверитьОбновленияВЦ()
	...
	Если День(ТекущаяДата()) = 1 И Формат(ТекущаяДата(), "ДЛФ=T") < "09:00:00"
		ИЛИ День(ТекущаяДата()) = 11 И Формат(ТекущаяДата(), "ДЛФ=T") < "09:00:00"
		ИЛИ День(ТекущаяДата()) = 21 И Формат(ТекущаяДата(), "ДЛФ=T") < "09:00:00"
		ИЛИ День(ТекущаяДата()) = 31 И Формат(ТекущаяДата(), "ДЛФ=T") < "09:00:00" Тогда
