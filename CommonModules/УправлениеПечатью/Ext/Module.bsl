...
Функция УпаковатьВАрхив(СписокФайлов)
	...
	ИмяВременногоКаталога = ФайловаяСистемаУдалить.СоздатьВременныйКаталог();
	СоздатьКаталог(ИмяВременногоКаталога);
	
	Для Каждого Файл Из СписокФайлов Цикл
		ИмяФайла = ИмяВременногоКаталога + Файл.ИмяФайла;
		ИмяФайла = ФайловаяСистемаУдалить.УникальноеИмяФайла(ИмяФайла);
	...
	ФайловаяСистемаУдалить.УдалитьВременныйКаталог(ИмяВременногоКаталога);
...
Функция ИмяФайлаОфисногоДокумента(Знач ИмяФайла, Знач ПереводитьВТранслит = Ложь) Экспорт
	...
	Если ПереводитьВТранслит Тогда
		ИмяФайла = СтроковыеФункцииУдалить.СтрокаЛатиницей(ИмяФайла)
	КонецЕсли;
...
Функция СтрокаЛатиницей(Строка) Экспорт
	...
	Возврат СтроковыеФункцииУдалить.СтрокаЛатиницей(Строка);
