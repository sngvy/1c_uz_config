...
Процедура ОбработкаУдаленияПроведения(Отказ)
	...
	Для каждого Стр Из ЭтотОбъект.Движения.ЗадолженностьПоОбъектам Цикл
		КредитныеИстории.УдалитьСобытиеСделки(Стр.Объект, ЭтотОбъект.Ссылка, "2.3");
		КредитныеИстории.УдалитьСобытиеСделки(Стр.Объект, ЭтотОбъект.Ссылка, "2.5");
	КонецЦикла;
...
Процедура ОбработкаПроведения(Отказ, РежимПроведения)
	...
	Для каждого Стр Из ЭтотОбъект.Объекты Цикл
		СобытиеЗафиксировано = КредитныеИстории.СобытиеСделкиЗафиксированоИсточником(Стр.Объект, ЭтотОбъект.Ссылка, "2.3");
		Если Не СобытиеЗафиксировано Тогда
			КредитныеИстории.ЗаписатьСобытиеСделки(Стр.Объект, Стр.ДатаПлатежа, ЭтотОбъект.Ссылка, "2.3");
		КонецЕсли;
	КонецЦикла;
