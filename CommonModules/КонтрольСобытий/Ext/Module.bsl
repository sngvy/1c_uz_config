	...
	Если Константы.КоличествоРезультативныхЗвонков.Получить() Тогда
		...
		Если Результат.Следующий() Тогда
			Если Результат.ЧислоРезультативных = КоличествоЗвонковДень
				...
				Сообщить("Число взаимодействий сегодня больше "+КоличествоЗвонковДень+"!");
				Возврат Истина;
			Иначе
			КонецЕсли;
		Иначе
		...
		Если Результат.Следующий() Тогда
			Если Результат.ЧислоРезультативных = КоличествоЗвонковНеделя
                ...
                Сообщить("Число взаимодействий на этой неделе больше "+КоличествоЗвонковНеделя+"!");
				Возврат Истина;
			Иначе
			КонецЕсли;
		Иначе
		...
		Если Результат.Следующий() Тогда
			Если Результат.ЧислоРезультативных = КоличествоЗвонковМесяц
				...
				Сообщить("Число взаимодействий в этом месяце больше "+КоличествоЗвонковМесяц+"!");
				Возврат Истина;
			Иначе
				Возврат Ложь;
			КонецЕсли;
...
Функция РезультативныеЗвонкиМесяц(Должник) Экспорт
	...
	Если Результат.Следующий() Тогда
		Если Результат.ЧислоРезультативных = 8
			...
			Сообщить("Число взаимодействий в этом месяце больше "+Результат.ЧислоРезультативных+"!");
			Возврат Истина;
		Иначе
			Возврат Ложь;
		КонецЕсли;
...
Функция КонтрольСМСПоКоличеству(Должник,ДатаСМС,Структура) Экспорт
	...
	Если Константы.КоличествоСМС.Получить() Тогда
		...
		Пока Результат.Следующий() Цикл
			Если Результат.КоличествоСообщений > КоличествоСМСДень-1 Тогда
				Структура.Вставить("Ошибка","Число сообщений сегодня больше "+КоличествоСМСДень+"!");
		...
		Пока Результат.Следующий() Цикл
			Если Результат.КоличествоСообщений > КоличествоСМСНеделя-1 Тогда
				Структура.Вставить("Ошибка","Число сообщений на этой неделе больше "+КоличествоСМСНеделя+"!");
		...
		Пока Результат.Следующий() Цикл
			Если Результат.КоличествоСообщений > КоличествоСМСМесяц-1 Тогда
				Структура.Вставить("Ошибка","Число сообщений в этом месяце больше "+КоличествоСМСМесяц+"!");
