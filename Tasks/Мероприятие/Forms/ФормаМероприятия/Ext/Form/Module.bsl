...
Процедура ПриОткрытии(Отказ)
	...
	Если ЗначениеЗаполнено(ЭтаФорма.Объект.Контакт) = Истина Тогда
		...
		ИначеЕсли ЭтаФорма.ПредупреждениеЮД = Истина Тогда
			Предупреждение("Договор находится в ЮД",,"Предупреждение");
		КонецЕсли;
	КонецЕсли;
...
Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник)
	...
	Если ИмяСобытия = "ЗаписьДолжника" Тогда
		...
		Предупреждение("Контактные данные обновлены. Проверьте контакт должника",1,"Обновление контактных данных");
	КонецЕсли;
