...
Процедура ПриОпределенииВозможныхКонтактов(ТипыКонтактов) Экспорт
	...
	//Если ЕмаилКонст.СправочникВладелец = ОбъектыСервер.ПолучитьЗначениеПВХ("ДополнительныеРеквизитыИСведения","Справочник_Контрагенты") Тогда
	//	ОписаниеТипаКонтакта.Тип                               = Новый ОписаниеТипов("СправочникСсылка.Контрагенты");
	//	ОписаниеТипаКонтакта.Имя                               = "Контрагенты";
	//	ОписаниеТипаКонтакта.Представление                     = НСтр("ru = 'Контрагенты'");
	//ИначеЕсли ЕмаилКонст.СправочникВладелец = ОбъектыСервер.ПолучитьЗначениеПВХ("ДополнительныеРеквизитыИСведения","Справочник_ДолговыеОбязательства") Тогда
	//	ОписаниеТипаКонтакта.Тип                               = Новый ОписаниеТипов("СправочникСсылка.ДолговыеОбязательства");
	//	ОписаниеТипаКонтакта.Имя                               = "ДолговыеОбязательства";
	//	ОписаниеТипаКонтакта.Представление                     = НСтр("ru = 'Долговые Обязательства'");
	//КонецЕсли;
