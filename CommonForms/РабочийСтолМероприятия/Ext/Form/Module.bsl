...
Процедура ПриОткрытии(Отказ)
	...
	// Сообщить о ротации
	Если День(ТекущаяДата()) = 17 Тогда
		ПоказатьОповещениеПользователя("Ротация",,"Осталось 3 дня до ротации",БиблиотекаКартинок.Предупреждение32,СтатусОповещенияПользователя.Важное);
	ИначеЕсли День(ТекущаяДата()) = 18 Тогда
		ПоказатьОповещениеПользователя("Ротация",,"Осталось 2 дня до ротации",БиблиотекаКартинок.Предупреждение32,СтатусОповещенияПользователя.Важное); 
	ИначеЕсли День(ТекущаяДата()) = 19 Тогда
		ПоказатьОповещениеПользователя("Ротация",,"Остался 1 день до ротации",БиблиотекаКартинок.Предупреждение32,СтатусОповещенияПользователя.Важное); 
	ИначеЕсли День(ТекущаяДата()) = 20 Тогда
		ПоказатьОповещениеПользователя("Ротация",,"Сегодня день ротации",БиблиотекаКартинок.Предупреждение32,СтатусОповещенияПользователя.Важное);
	КонецЕсли;
...
Процедура НоваяЗадача(Команда)
	ОткрытьФорму("РегистрСведений.УчетРабочегоВремени.ФормаЗаписи");
КонецПроцедуры
...
Процедура ПосчитатьДолжников(Команда)
	...
	ПоказатьОповещениеПользователя("Количество должников",,"В портфеле "+ЭтаФорма.КоличествоВРаботе+" должников",БиблиотекаКартинок.Информация32);
КонецПроцедуры
