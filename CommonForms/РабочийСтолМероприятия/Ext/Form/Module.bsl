...
Процедура ПриОткрытии(Отказ)
	...
	Если День(ТекущаяДата()) = 17 Тогда
		ПоказатьОповещениеПользователя("Ротация",,"Осталось 3 дня до ротации",БиблиотекаКартинок.Предупреждение32);
	ИначеЕсли День(ТекущаяДата()) = 18 Тогда
		ПоказатьОповещениеПользователя("Ротация",,"Осталось 2 дня до ротации",БиблиотекаКартинок.Предупреждение32); 
	ИначеЕсли День(ТекущаяДата()) = 19 Тогда
		ПоказатьОповещениеПользователя("Ротация",,"Остался 1 день до ротации",БиблиотекаКартинок.Предупреждение32); 
	ИначеЕсли День(ТекущаяДата()) = 20 Тогда
		ПоказатьОповещениеПользователя("Ротация",,"Сегодня день ротации",БиблиотекаКартинок.Предупреждение32);
	КонецЕсли;
...
&НаКлиенте
Процедура ПосчитатьКоличествоДолжников(Команда)
	// Посчитать и сообщить количество должников
	ПолучитьКоличествоСтрокВДинамическомСпискеНаСервере();
	ПоказатьОповещениеПользователя("Договоров в работе:",,ЭтаФорма.КоличествоВРаботе,БиблиотекаКартинок.Информация32);
КонецПроцедуры
