...
Функция ЗаполнитьОписаниеПисьма(ОбъектВх, ТипПисьма, ТемаПисьма)
	...
	НастойкаПараметровПисем = бит_ИнтеграцияПочтаРФ.ВернутьПараметрыПисем(ОбъектВх.ТипПисьма);
	бит_ИнтеграцияПочтаРФ.ЗаполнитьПараметрыИсходящейКорреспонденции(ОбъектВх, НастойкаПараметровПисем);
