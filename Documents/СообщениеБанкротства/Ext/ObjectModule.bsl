...
Процедура ОбработкаПроведения(Отказ, РежимПроведения)
	...
	Если Не ЗначениеЗаполнено(НомерСудебногоДела) Тогда
		
		СобытиеЗафиксировано = КредитныеИстории.СобытиеСубъектаЗафиксированоИсточником(Контрагент, ЭтотОбъект.Ссылка, "1.12");
		Если Не СобытиеЗафиксировано Тогда 
			КредитныеИстории.ЗаписатьСобытиеСубъекта(Контрагент, ЭтотОбъект.Дата, ЭтотОбъект.Ссылка, "1.12");		 
		КонецЕсли;  
