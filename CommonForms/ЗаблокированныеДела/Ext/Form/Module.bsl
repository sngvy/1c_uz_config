...
Процедура Разблокировать(Команда)
	Если ЭтаФорма.ТекущийЭлемент = ЭтаФорма.Элементы.СписокДО И Элементы.СписокДО.ТекущиеДанные <> Неопределено Тогда
		...
		Состояние("Разблокировка дел", 50, "Пожалуйста, подождите...", БиблиотекаКартинок.NC_Разблокировано);
		РазблокироватьНаСервере();
		Состояние("Разблокировка дел", 100, "Пожалуйста, подождите...", БиблиотекаКартинок.NC_Разблокировано);
