...
Процедура ФормированиеСписковАвтообзвона() Экспорт
	...
	|	КОЛИЧЕСТВО(Мероприятие.Результат.РезультативныйКонтакт) КАК РезультатРезультативныйКонтакт
	|ИЗ
	...
	|			ИЛИ ДолговыеОбязательства.ДополнительныеРеквизиты.Значение.Наименование В (""В работе"", ""Новые"")
	...
	|	Мероприятие.Результат.РезультативныйКонтакт
	|
	|ИМЕЮЩИЕ
	...
	|
	|УПОРЯДОЧИТЬ ПО
	|	РезультатРезультативныйКонтакт УБЫВ";
...
Процедура ОбновлениеОстатков() Экспорт
	...
	СписатьСуммыУдержаний();
	
КонецПроцедуры

Процедура СписатьСуммыУдержаний()
...
Процедура БлокировкаНеконтактныхДелДляАвтообзвона() Экспорт
	...
	|	И ДолговыеОбязательства.НеконтактныеНомера = ЛОЖЬ
	|	И Мероприятие.Ссылка ЕСТЬ НЕ NULL 
	|	И Мероприятие.ТипМероприятия.Наименование В (""Телефонный звонок исходящий"", ""Телефонный звонок входящий"")
