...
Процедура ДопРеквизитДолжник(Команда)
	ДопРеквизит(ПредопределенноеЗначение("Перечисление.ВидыНазначенийСвойств.Должники"));
...
Процедура ЗаполнитьТаблицуДанныхНаСервере()	
	...
	//	Для Каждого Элемент из Объект.НастройкаСоответствий Цикл
	//		КолонкиТаблицыЦенДоб.Добавить("тзДанные." + СтрЗаменить(Строка(Элемент.Назначение)," ", "") + "_" + СтрЗаменить(Строка(Элемент.ВидРеквизита), " ", "") + "_" + СтрЗаменить(Строка(Элемент.КодСвойства), " ", "_"));
	//	КонецЦикла;
	...
	//Попытка
	//	Для Каждого Элемент Из Объект.НастройкаСоответствий Цикл
	//		Элементы.Удалить(Элементы["тзДанные" + СтрЗаменить(Строка(Элемент.Назначение)," ", "") + "_" + СтрЗаменить(Строка(Элемент.ВидРеквизита), " ", "") + "_" + СтрЗаменить(Строка(Элемент.КодСвойства), " ", "_")]);
	//	КонецЦикла;
	//Исключение
	//	Сообщить("ббб");
	//КонецПопытки;
