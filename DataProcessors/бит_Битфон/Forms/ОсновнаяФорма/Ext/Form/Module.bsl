...
Процедура КН1(Команда)
	...
	// Исправить отсутствие реакции на нажатие кнопок нампада
    ЭтаФорма.НомерЛиния1 = ЭтаФорма.НомерЛиния1 + КодКнопки;
	ЭтаФорма.НомерЛиния2 = ЭтаФорма.НомерЛиния2 + КодКнопки;
	ЭтаФорма.НомерЛиния3 = ЭтаФорма.НомерЛиния3 + КодКнопки;
	ЭтаФорма.НомерЛиния4 = ЭтаФорма.НомерЛиния4 + КодКнопки;
КонецПроцедуры
...
Процедура КНЗВ(Команда)
	...
	// Исправить отсутствие реакции на нажатие кнопок нампада
    ЭтаФорма.НомерЛиния1 = ЭтаФорма.НомерЛиния1 + стрКомЗв;
	ЭтаФорма.НомерЛиния2 = ЭтаФорма.НомерЛиния2 + стрКомЗв;
	ЭтаФорма.НомерЛиния3 = ЭтаФорма.НомерЛиния3 + стрКомЗв;
	ЭтаФорма.НомерЛиния4 = ЭтаФорма.НомерЛиния4 + стрКомЗв;
КонецПроцедуры
...
Процедура КНРеш(Команда)
	...
	// Исправить отсутствие реакции на нажатие кнопок нампада
    ЭтаФорма.НомерЛиния1 = ЭтаФорма.НомерЛиния1 + стрКомРеш;
	ЭтаФорма.НомерЛиния2 = ЭтаФорма.НомерЛиния2 + стрКомРеш;
	ЭтаФорма.НомерЛиния3 = ЭтаФорма.НомерЛиния3 + стрКомРеш;
	ЭтаФорма.НомерЛиния4 = ЭтаФорма.НомерЛиния4 + стрКомРеш;
КонецПроцедуры
...
Процедура ОбновитьСтатусАбонентаSIP(ИдентификаторАбонента)
	...
	// Заглушка для исключения ошибки при невозможности обновить статусы
