...
Процедура ЗаполнитьСобытияКИ(Команда)
	...
	Для Каждого Эл Из Массив Цикл
		...
		Ном = Ном + 1;
	КонецЦикла;
	ПоказатьОповещениеПользователя("Интеграция с НБКИ",,"События КИ сформированы",БиблиотекаКартинок.NC_ПодсистемаОбменСНБКИ);
КонецПроцедуры
...
Процедура ПрекратитьОбязательство(Команда)
	...
	Для Каждого Эл Из Массив Цикл	
		...
		ИнтеграцииСлужебный.Пауза(10);
		ПрекратитьОбязательствоНаСервере(Ссылка);
		Ном = Ном + 1;
	КонецЦикла;	
	ПоказатьОповещениеПользователя("Интеграция с НБКИ",,"Обязательства прекращены",БиблиотекаКартинок.NC_ПодсистемаОбменСНБКИ);
КонецПроцедуры
...
Процедура СформироватьОтчетВНБКИ(Команда)
	...
	ПоказатьОповещениеПользователя("Интеграция с НБКИ",,"Отчеты в НБКИ сформированы",БиблиотекаКартинок.NC_ПодсистемаОбменСНБКИ);
КонецПроцедуры
