					...
					ЧтениеJSON.Закрыть();
						...
						Если ОбъектыСервер.ПолучитьЗначениеСвойства(ДО,"0182") <> Справочники.тсЗначенияСвойствОбъектов.НайтиПоКоду("000000048") Тогда // Проверка на передачу в ЮД 
							Если Стадия = "Производство по делу завершено"
								ИЛИ Стадия = "Сообщение о завершении процедуры внесудебного банкротства гражданина" Тогда
							...
							ИначеЕсли
								...
								И Стадия <> "Сообщение о возврате гражданину поданного им заявления о признании гражданина банкротом во внесудебном порядке" Тогда
