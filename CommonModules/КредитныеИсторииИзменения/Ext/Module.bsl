...
Процедура ОбновитьТекущиеЗаписиСделки(Настройка, МассивСделка, ПрогрессВыполнения, ВсегоОбъектов) Экспорт
	...
	ВсегоОбъектов = ВыборкаДетальныеЗаписи.Количество() * 2;
...
Процедура ЗаменитьНеиспользуемыеКодыТипаКредита(ЗначениеПокзателя) Экспорт 
	Если  ЗначениеПокзателя = "3" Тогда
		ЗначениеПокзателя = "6";
	КонецЕсли;	
	
	Если  ЗначениеПокзателя = "4" Тогда
		ЗначениеПокзателя = "9";
	КонецЕсли;	
	
КонецПроцедуры 

Процедура ЗаменитьНеиспользуемыеКодыВидаКредита(ЗначениеПокзателя) Экспорт  
	Если ЗначениеПокзателя = "1" Тогда
		ЗначениеПокзателя = "99";
	КонецЕсли;	 
	
	Если ЗначениеПокзателя = "3" Тогда
		ЗначениеПокзателя = "13";
	КонецЕсли;	
...
Функция СписокИзмененийВерия5() Экспорт 
...
Функция ИсторияКонтроляВерсий() Экспорт 
	//Для обновления
...
Функция ОбновитьКонфигурационныйРегистр(Версия) Экспорт
