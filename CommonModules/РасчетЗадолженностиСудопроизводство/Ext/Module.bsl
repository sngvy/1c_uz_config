...
Функция РассчитатьГоспошлинуФЛ_ДоИндексации(СуммаИска) Экспорт
...
Функция РассчитатьГоспошлинуЮр_ДоИндексации(СуммаИска) Экспорт
...
Функция РсчитатьГоспошлинуФЛ_ПослеИндексации(СуммаИска) Экспорт
	
	Если СуммаИска <= 100000 Тогда
		
		Сумма = 4000;
		
	ИначеЕсли СуммаИска >= 100001 И СуммаИска <= 300000 Тогда
		Сумма = 4000 + (СуммаИска - 100000) * 0.03;
	ИначеЕсли СуммаИска >= 300001 И СуммаИска <= 500000 Тогда
		Сумма = 10000 + (СуммаИска - 300000) * 0.025;
	ИначеЕсли СуммаИска >= 500001 И СуммаИска <= 1000000 Тогда
		Сумма = 15000 + (СуммаИска - 500000) * 0.02;
	ИначеЕсли СуммаИска >= 1000001 И СуммаИска <= 3000000 Тогда
		Сумма = 25000 + (СуммаИска - 1000000) * 0.01;
	ИначеЕсли СуммаИска >= 3000001 И СуммаИска <= 8000000 Тогда
		Сумма = 45000 + (СуммаИска - 3000000) * 0.007;
	ИначеЕсли СуммаИска >= 8000001 И СуммаИска <= 24000000 Тогда
		Сумма = 80000 + (СуммаИска - 8000000) * 0.0035;	
	ИначеЕсли СуммаИска >= 24000001 И СуммаИска <= 50000000 Тогда
		Сумма = 136000 + (СуммаИска - 24000000) * 0.003;
	ИначеЕсли СуммаИска >= 50000001 И СуммаИска <= 100000000 Тогда
		Сумма = 214000 + (СуммаИска - 50000000) * 0.002;
	ИначеЕсли СуммаИска >= 100000001 Тогда
		Расчет = (СуммаИска - 100000000) * 0.0015;
		Если Расчет > 900000 Тогда
			Расчет = 900000;
		КонецЕсли;
		Сумма = 314000 + Расчет;
	КонецЕсли;
...
Функция РассчитатьГоспошлинуЮЛ_ПослеИндексации(СуммаИска) Экспорт
	...
	ИначеЕсли СуммаИска >= 100001 И СуммаИска <= 1000000 Тогда
		Сумма = 10000 + (СуммаИска - 100000) * 0.05;
	ИначеЕсли СуммаИска >= 1000001 И СуммаИска <= 10000000 Тогда
		Сумма = 55000 + (СуммаИска - 1000000) * 0.03;
	ИначеЕсли СуммаИска >= 10000001 И СуммаИска <= 50000000 Тогда
		Сумма = 325000 + (СуммаИска - 10000000) * 0.01;
	ИначеЕсли СуммаИска >= 50000001 Тогда
		Сумма = 725000 + (СуммаИска - 50000000) * 0.005;
		Если Сумма > 10000000 Тогда
			Сумма = 10000000;
		КонецЕсли;
	КонецЕсли;
